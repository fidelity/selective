...
We are to happy to have you contribute! The project is hosted on `GitHub` and the easiest way to get started is to check out the "Issues" sections of the repo.
...
* **Contributions are accompanied by documentation.** Selective uses the `numpydoc` standard.
